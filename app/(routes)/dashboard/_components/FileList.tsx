  ...
  <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
    <thead className="ltr:text-left rtl:text-right">
      <tr>
        ...
        <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Create At</th>
    ...
    <tbody className="divide-y divide-gray-200">
        {fileList&&fileList.map((file:FILE,index:number)=>(
            <tr className='cursor-pointer hover:bg-gray-200' onClick={()=>router.push('/workspace/'+file._id)}>
          ...
          <DropdownMenu>
  <DropdownMenuTrigger><MoreHorizontalIcon/></DropdownMenuTrigger>
  <DropdownMenuContent>
